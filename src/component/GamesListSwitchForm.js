...
const SwitchFormModal = observer(({
  open,
  onClose,
  gameId,
  onSubmit,
...
const GameListSwitchForm = observer(({ 
  GameSwitchList, 
  tableColumn,
  onDialogClose,
  dialog,
      ...
      <CardHeader
        title={
          <Typography
            ...
            gutterBottom
          >
            Lista de Juegos Nintendo Switch
          </Typography>
        }
        disableTypography
      />
...
GameListSwitchForm.propTypes = {
    GameSwitchList: PropTypes.array.isRequired
};

export default GameListSwitchForm;